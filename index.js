...
async function ScanTab(Tab, [min, max], CC=null){
	console.clear();
	console.log(`[Scaneando Pestaña]:`, (max/100000));
	try {
		...
		console.log("[Retry]: ", Client);
		return ScanTab(Tab, [min, max], (CC+1));
	} catch (error) {
		console.clear();
		console.log(error);
		await sleep(3000);
...
module.exports.Procuraduria = (async function Procuraduria(){
